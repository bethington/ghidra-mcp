...
Run `python scripts/validate_function_names.py` to identify functions needing review. The script filters out valid patterns and groups violations by reason.
