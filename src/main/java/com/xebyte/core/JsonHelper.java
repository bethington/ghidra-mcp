...
public final class JsonHelper {
    ...
    /** Parse a JSON string into a map. Returns empty map for null/blank or invalid JSON. */
    @SuppressWarnings("unchecked")
    ...
    /** Get a string value from a map (null-safe). Handles Number/Boolean by toString. */
