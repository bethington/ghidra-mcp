...
MCP server bridging Ghidra reverse engineering with AI tools. 241 MCP tools for binary analysis.

- **Package**: `com.xebyte` | **Version**: 5.7.2 | **Java**: 21 LTS | **Ghidra**: 12.0.4
