...
- **Authoritative repo snapshot**: `tests/endpoints.json` (253 endpoints, categories, descriptions, and which server serves each). 239 are on the GUI plugin, 226 on the headless server, 212 on both.
