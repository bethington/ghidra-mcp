...
MCP server bridging Ghidra reverse engineering with AI tools. 254 MCP tools for binary analysis.
...
- **Authoritative repo snapshot**: `tests/endpoints.json` (254 endpoints, categories, descriptions)
