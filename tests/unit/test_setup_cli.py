"""
Unit tests for tools.setup.cli — subcommand routing, helpers.
...
def test_cmd_ensure_prereqs_dry_run_prints_plan(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr(cli, "install_ghidra_dependencies", lambda root, path, force=False, dry_run=False: 0)
