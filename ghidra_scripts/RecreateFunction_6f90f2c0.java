// RecreateFunction_6f90f2c0.java
// Deletes and recreates a function at 0x6f90f2c0
//@author Claude
//@category Functions
...
public class RecreateFunction_6f90f2c0 extends GhidraScript {

    @Override
    public void run() throws Exception {
        Address targetAddr = toAddr(0x6f90f2c0L);
        ...
        // Clear and recreate - WndProc functions are typically ~0x80-0x100 bytes
        Address endAddr = targetAddr.add(0x100);
