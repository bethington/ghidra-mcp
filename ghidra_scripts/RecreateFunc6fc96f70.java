//Recreate function at 0x6fc96f70
//@category Fix
//@keybinding
//@menupath
//@toolbar
...
public class RecreateFunc6fc96f70 extends GhidraScript {
    @Override
    public void run() throws Exception {
        Address addr = toAddr(0x6fc96f70L);
        ...
        Function newFunc = createFunction(addr, "FUN_6fc96f70");
        if (newFunc != null) {
