//Recreate function at 0x6fc8f4f0
//@category Repair
...
public class RecreateFunction6fc8f4f0 extends GhidraScript {
    @Override
    public void run() throws Exception {
        Address addr = toAddr(0x6fc8f4f0);
        ...
        clearListing(addr, addr.add(0xE0));
