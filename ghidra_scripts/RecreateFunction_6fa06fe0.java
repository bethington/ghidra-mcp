// RecreateFunction_6fa06fe0.java
// Deletes and recreates a function at 0x6fa06fe0
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa06fe0 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address
        Address targetAddr = toAddr(0x6fa06fe0L);
        ...
        // The function ends at RET 4 (C2 04 00) - approximately 0x100 bytes from start
        Address endAddr = targetAddr.add(0x120); // Max range to clear
