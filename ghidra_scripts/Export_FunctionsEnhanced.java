// Functions Enhanced
//
// Exports all functions with callees, callers, string references, and instruction sequences for cross-version comparison matching. Includes decompiler output.
//
// Usage: Run from Script Manager on any program.
// Output: JSON at data/enhanced/{GameType}/{Version}/{dll}.json.
//
// @author Ben Ethington
// @category Diablo 2.Export
// @description Export functions with extended cross-version data
// @menupath Diablo 2.Export.Functions Enhanced
...
public class Export_FunctionsEnhanced extends GhidraScript {
