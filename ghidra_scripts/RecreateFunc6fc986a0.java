//Recreate function at 0x6fc986a0
//@category Fix
//@keybinding
//@menupath
//@toolbar
...
public class RecreateFunc6fc986a0 extends GhidraScript {
    @Override
    public void run() throws Exception {
        Address addr = toAddr(0x6fc986a0L);
        ...
        Function newFunc = createFunction(addr, "FUN_6fc986a0");
        if (newFunc != null) {
