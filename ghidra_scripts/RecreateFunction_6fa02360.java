// RecreateFunction_6fa02360.java
// Deletes and recreates a function at 0x6fa02360
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa02360 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address for this function
        Address targetAddr = toAddr(0x6fa02360L);
        ...
        // Based on decompiled code size, estimate ~0x400 bytes for this large function
        Address endAddr = targetAddr.add(0x400);
