// Verify Edge Case Fixes
//
// Tests specific functions identified with calling convention detection issues against expected values. Validates parameter counts, conventions, and detection patterns.
//
// Usage: Run from Script Manager after applying convention fixes.
// Output: Console pass/fail report for each test case.
//
// @author Ben Ethington
// @category Diablo 2.Analysis
// @description Verify edge case fixes for convention detection
// @menupath Diablo 2.Analysis.Verify Edge Case Fixes

import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class Analyze_VerifyEdgeCaseFixes extends GhidraScript {
