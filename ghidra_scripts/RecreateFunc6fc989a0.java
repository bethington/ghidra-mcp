//Recreate function at 0x6fc989a0
//@category Fix
//@keybinding
//@menupath
//@toolbar
...
public class RecreateFunc6fc989a0 extends GhidraScript {
    @Override
    public void run() throws Exception {
        Address addr = toAddr(0x6fc989a0L);
        ...
        Function newFunc = createFunction(addr, "FUN_6fc989a0");
        if (newFunc != null) {
