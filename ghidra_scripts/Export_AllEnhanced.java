// All Enhanced
//
// Iterates through all programs in the project and exports enhanced function data (callees, callers, strings, instructions) for each to structured JSON files.
//
// Usage: Run from Script Manager. Processes entire project.
// Output: JSON files at data/enhanced/{GameType}/{Version}/{dll}.json.
//
// @author Ben Ethington
// @category Diablo 2.Export
// @description Export enhanced function data for all project programs
// @menupath Diablo 2.Export.All Enhanced
 ...
 */
public class Export_AllEnhanced extends GhidraScript {
