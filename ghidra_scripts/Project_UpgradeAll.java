// Upgrade All
//
// Iterates through every program in the project and upgrades each to the latest Ghidra version format. Tracks upgraded, skipped, and error counts.
//
// Usage: Run from Script Manager. Processes entire project recursively.
// Output: Upgrades all programs to the current Ghidra version.
//
// @author Ben Ethington
// @category Diablo 2.Project
// @description Upgrade all programs to latest Ghidra format
