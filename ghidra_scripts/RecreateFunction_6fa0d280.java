// RecreateFunction_6fa0d280.java
// Deletes and recreates a function at 0x6fa0d280
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa0d280 extends GhidraScript {

    @Override
    public void run() throws Exception {
        Address targetAddr = toAddr(0x6fa0d280L);
        Address endAddr = toAddr(0x6fa0d6d0L); // Just past RET 0x8
