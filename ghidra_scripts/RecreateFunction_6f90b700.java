// RecreateFunction_6f90b700.java
// Recreates function at 0x6f90b700 with correct boundaries
//@author Claude
//@category Functions
...
public class RecreateFunction_6f90b700 extends GhidraScript {

    @Override
    public void run() throws Exception {
        Address targetAddr = toAddr(0x6f90b700L);
        ...
        // Clear and disassemble - function ends at RET (C3) around 0x6f90b71c
        Address endAddr = targetAddr.add(0x30);
