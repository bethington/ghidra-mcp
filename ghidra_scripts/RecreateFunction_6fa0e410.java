// RecreateFunction_6fa0e410.java
// Deletes and recreates a function at 0x6fa0e410
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa0e410 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address - stub function that returns 0
        Address targetAddr = toAddr(0x6fa0e410L);
        ...
        // Clear listing - function is only 5 bytes (XOR EAX,EAX + RET 8)
        Address endAddr = targetAddr.add(0x10);
