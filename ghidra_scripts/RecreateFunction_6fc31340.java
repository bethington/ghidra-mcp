// RecreateFunction_6fc31340.java
// Recreates NET_ClientReceiveThreadProc function with correct boundaries
//@author Claude
//@category Functions
...
public class RecreateFunction_6fc31340 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address for NET_ClientReceiveThreadProc
        Address targetAddr = toAddr(0x6fc31340L);
        // Function ends just before FUN_6fc315e0
        Address endAddr = toAddr(0x6fc315dfL);
        ...
        // Create function
        Function newFunc = createFunction(targetAddr, "NET_ClientReceiveThreadProc");
        if (newFunc != null) {
