// RecreateFunction_6fa0ef50.java
// Deletes and recreates function at 0x6fa0ef50 which has incomplete boundaries
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa0ef50 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address
        Address targetAddr = toAddr(0x6fa0ef50L);
        ...
        // Function ends before 0x6fa0f000 - look at bytes, RET 0C 00 at ~0x6fa0ef9e
        Address endAddr = targetAddr.add(0xAF); // Through 0x6fa0efff
