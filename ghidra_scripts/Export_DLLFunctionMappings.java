// DLL Function Mappings
//
// Exports all function addresses and names for the currently loaded program to a text file. Useful for creating cross-reference tables and ordinal mapping files.
//
// Usage: Run from Script Manager on any loaded program.
// Output: Text file with function address-name mappings.
//
// @author Ben Ethington
// @category Diablo 2.Export
// @description Export DLL function address-to-name mappings
// @menupath Diablo 2.Export.DLL Function Mappings
...
public class Export_DLLFunctionMappings extends GhidraScript {
