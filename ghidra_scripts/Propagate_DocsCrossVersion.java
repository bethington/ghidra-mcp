// Docs Cross Version
//
// Compares functions between source and target programs using opcode hashes. Copies function name, prototype, and plate comment for matches. Replaces manual Phase 6 PROPAGATE.
//
// Usage: Args: [0]=target program path, or prompted interactively.
// Output: Copies documentation from source to target for hash-matched functions.
//
// @author Ben Ethington
// @category Diablo 2.Propagation
// @description Propagate full docs between program versions
// @menupath Diablo 2.Propagation.Docs Cross Version
...
public class Propagate_DocsCrossVersion extends GhidraScript {
