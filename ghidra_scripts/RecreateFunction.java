...
// Deletes and recreates a function at a specific address by disassembling the code first
//@author Claude
//@category Functions
...
public class RecreateFunction extends GhidraScript {
    ...
    public void run() throws Exception {
        // Target address - hardcoded for now
        Address targetAddr = toAddr(0x6fa10380L);
        ...
        // Find where the function should end (look for RET 0x10 = C2 10 00)
        Address endAddr = targetAddr.add(0x5f); // End before next function at 0x6fa103e0
