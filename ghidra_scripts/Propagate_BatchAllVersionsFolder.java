// Batch All Versions Folder
//
// Automatically propagates documentation (function names, signatures, plate comments, data types) to all versions of all binaries in the current project folder using the hash index.
//
// Usage: Run after BuildHashIndex. Processes all binaries in the folder.
// Output: Propagates documentation across all binary versions in the folder.
//
// @author Ben Ethington
// @category Diablo 2.Propagation
// @description Batch propagate docs for all binaries in a folder
// @menupath Diablo 2.Propagation.Batch All Versions Folder
...
public class Propagate_BatchAllVersionsFolder extends GhidraScript {
