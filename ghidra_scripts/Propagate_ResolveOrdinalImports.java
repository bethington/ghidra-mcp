...
//
// Resolves ordinal imports by finding the exporting DLL in the same project folder and looking up actual function names and signatures. Applies both name and signature to imports.
//
// Usage: Run from Script Manager on any program with ordinal imports.
// Output: Renames ordinal imports and applies correct function signatures.
//
// @author Ben Ethington
// @category Diablo 2.Propagation
// @description Resolve ordinal imports from sibling DLL exports
// @menupath Diablo 2.Propagation.Resolve Ordinal Imports
 ...
 */
public class Propagate_ResolveOrdinalImports extends GhidraScript {
