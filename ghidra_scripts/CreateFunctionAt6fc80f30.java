//Creates a function at 0x6fc80f30
//@category Functions
//@keybinding
//@menupath
//@toolbar
...
public class CreateFunctionAt6fc80f30 extends GhidraScript {
    @Override
    public void run() throws Exception {
        // Target address for the function we need to create
        String addrString = "6fc80f30";
        ...
        if (existingFunc != null) {
            ...
            // Delete and recreate if it's truncated (1 byte body = broken)
            if (existingFunc.getBody().getNumAddresses() <= 1) {
                println("Function is truncated! Removing...");
                funcMgr.removeFunction(addr);
            } else {
                println("Function looks OK, skipping recreation.");
                return;
            }
        }
