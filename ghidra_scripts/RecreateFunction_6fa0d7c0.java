// RecreateFunction_6fa0d7c0.java
// Deletes and recreates a function at 0x6fa0d7c0
//@author Claude
//@category Functions
...
public class RecreateFunction_6fa0d7c0 extends GhidraScript {

    @Override
    public void run() throws Exception {
        // Target address
        Address targetAddr = toAddr(0x6fa0d7c0L);
        ...
        Address endAddr = targetAddr.add(0x100); // 256 bytes should be enough
