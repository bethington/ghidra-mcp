// Batch All Binaries
//
// Analyzes all programs in the project folder and generates a consolidated todo list ordered by binary dependency hierarchy following the documentation order.
//
// Usage: Run from Script Manager. Processes binaries in dependency order.
// Output: FunctionsTodo.txt and FunctionsReport_AllBinaries.txt files.
//
// @author Ben Ethington
// @category Diablo 2.Documentation
// @description Batch document functions across all binaries in folder
// @menupath Diablo 2.Documentation.Batch All Binaries
...
public class Document_BatchAllBinaries extends GhidraScript {
