...
- Deploy: `python -m tools.setup ensure-prereqs --ghidra-path F:\ghidra_12.1.3_PUBLIC` then `python -m tools.setup build` then `python -m tools.setup deploy --ghidra-path F:\ghidra_12.1.3_PUBLIC`
